...
var dataPopulate = function (resp) {
...
var getDataFindFromTo = function () {
  var getDataObj = {};
  var sort;
  $('.inputsrows').each((index, el) => {
...
var onAddNewBtnClicked = function (e) {
  e.preventDefault();
  e.stopPropagation();
...
var onClearBtnClicked = function (e) {
  e.preventDefault();
  e.stopPropagation();
...
var getDataDistFromTo = function () {
